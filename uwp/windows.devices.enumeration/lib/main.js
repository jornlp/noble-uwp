...
if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Devices_Enumeration.d.js)'))) {
  module.exports = require('./NodeRT_Windows_Devices_Enumeration.d.js');
} else {
  module.exports = require('../build/Release/binding.node');
}

var externalReferencedNamespaces = ['Windows.Foundation', 'Windows.Security.Credentials', 'Windows.UI.Popups', 'Windows.Storage.Streams', 'Windows.ApplicationModel.Background'];
