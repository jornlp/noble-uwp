...
if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Devices_Bluetooth.d.js)'))) {
  module.exports = require('./NodeRT_Windows_Devices_Bluetooth.d.js');
} else {
  module.exports = require('../build/Release/binding.node');
}

var externalReferencedNamespaces = ['Windows.Devices.Radios', 'Windows.Networking', 'Windows.Devices.Bluetooth.Rfcomm', 'Windows.Storage.Streams', 'Windows.Devices.Enumeration', 'Windows.Devices.Bluetooth.GenericAttributeProfile'];
